...
class AdminHappening extends React.Component<AdminHappeningProps, AdminHappeningState> {
  ...
  deleteHappening() {
    http.delete("http://localhost:4000/api/happening/" + this.state._id)
  ...
  updateHappening(name?) {
    ...
    if (typeof name !== "undefined") updatedHappening[name] = this.state.editVal;

    http.put("http://localhost:4000/api/happening/" + this.state._id, updatedHappening)
      .then((response: ServerData) => {
        this.getHappening(this.state._id);
  ...
  handleDateChange(newDate) {
    ...
    for (let i = 0; i < this.state.selectedDates.length; i++) {
      if (this.state.selectedDates[i].format("YYYY-MM-DD") === newDate.format("YYYY-MM-DD")) {
        notFound = false;
  ...
  render() {
    return (
      <div className="admin-happening-container" >
        ...
        <List component="nav">
          <ListItem button={this.state.editName === ''} divider onClick={() => this.handleEditClick('title')}>
            {this.state.editName !== 'title' ? (
              ...
              <div className='admin-happening-textfield-wrapper'>
                <FormControl className="admin-happening-textfield" >
                  ...
                  <Input value={this.state.editVal} onChange={this.handleChange} />
                </FormControl>
                <Button variant="outlined" type='submit' color="secondary" className='admin-happening-button' onClick={() => this.handleCancel('title')}>Cancel</Button>
                <Button variant="outlined" type='submit' color="primary" className='admin-happening-button' onClick={() => this.updateHappening('title')}>Save</Button>
              </div>
            ) : null}
          </ListItem>

          <ListItem button={this.state.editName === ''} divider onClick={() => this.handleEditClick('description')}>
            {this.state.editName !== 'description' ? (
              ...
              <div className='admin-happening-textfield-wrapper'>
                <FormControl className="admin-happening-textfield" >
                  ...
                  <Input multiline={true} value={this.state.editVal} onChange={this.handleChange} />
                </FormControl>
                <Button variant="outlined" type='submit' color="secondary" className='admin-happening-button' onClick={() => this.handleCancel('description')}>Cancel</Button>
                <Button variant="outlined" type='submit' color="primary" className='admin-happening-button' onClick={() => this.updateHappening('description')}>Save</Button>
              </div>
            ) : null}
          </ListItem>

          <ListItem button={this.state.editName === ''} divider onClick={() => this.handleEditClick('price')}>
            {this.state.editName !== 'price' ? (
              ...
              <div className='admin-happening-textfield-wrapper'>
                ...
                <Button variant="outlined" type='submit' color="secondary" className='admin-happening-button' onClick={() => this.handleCancel('price')}>
                  Cancel
                </Button>
                <Button variant="outlined" type='submit' color="primary" className='admin-happening-button' onClick={() => this.updateHappening('price')}>
                  Save
                </Button>
              </div>
            ) : null}
          ...
          <ListItem button={this.state.editName === ''} divider onClick={() => this.handleEditClick('days')}>
            {this.state.editName !== 'days' ? (
              ...
              <div className='admin-happening-textfield-wrapper admin-happening-datepicker-wrapper'>
                ...
                />
                <div>
                  <Button variant="outlined" type='submit' color="secondary" className='admin-happening-button' onClick={() => this.handleCancel('days')}>Cancel
                </Button>
                  <Button variant="outlined" type='submit' color="primary" className='admin-happening-button' onClick={() => this.handleDateSave()}>Save</Button>
                </div>
              </div>
            ) : null}
          </ListItem>
        ...
        <Button variant="outlined" type='submit' color="primary" className='admin-happenings-delete-button' onClick={this.deleteHappening}>Delete</Button>
